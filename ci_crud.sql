...
(5, 'Tag Heuer Carrera', 'This luxury watch is available for sale please click on Details for more information.');
...
(1, 'Omega Speedmaster', 'Omega', '4999.99', 'omega_speedmaster.jpg', 'A legendary watch with a rich history, known for its precision and durability', 0),
(2, 'Rolex Submariner', 'Rolex', '8999.99', 'rolex_submariner.jpg', 'An iconic dive watch that combines style with functionality', 0),
(3, 'Tag Heuer Carrera', 'Tag Heuer', '2999.99', 'tag_heuer_carrera.jpg', 'A sporty and elegant chronograph that stands out for its performance and design', 0);
